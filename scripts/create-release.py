...
# 1. update version number in plate_model_manager/__init__.py
...
lines = []
with open(f"{this_file_path}/../src/plate_model_manager/__init__.py", "r") as f:
    for line in f:
...
with open(f"{this_file_path}/../src/plate_model_manager/__init__.py", "w") as of:
    of.writelines(lines)
